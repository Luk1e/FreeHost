...
function Apartment(props) {
  ...
  const userDeleteApartments=useSelector((state)=>state.userDeleteApartments)
  ...
  return (
    <div className="apartment-container" style={{ display: display ? "flex" : "none"}}>
      <div className="apartment-inner-container">
        ...
        <div className="apartment-duo">
          <div className="apartment-duoL">
            ...
            <div className="apartment-inline">
              <b>amenities: </b>
              {props.apartment.amenities.length==0 ? "none" : props.apartment.amenities.map((element) =>
                element !=
                props.apartment.amenities[props.apartment.amenities.length - 1]
                  ? element + ", "
                  : element
              )}
            </div>
        ...
        <div className="apartment-btn-container">
            <button className="apartment-btn" onClick={()=>{navigate(`/apartments/${props.apartment.id}/edit`)}}>edit</button>
            <button className="apartment-btn" onClick={()=>DeleteHandler()}>delete</button>
          </div>
      </div>
    </div>
  );
