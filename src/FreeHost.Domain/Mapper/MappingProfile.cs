...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<IEnumerable<DateTime>, IEnumerable<AvailableDate>>().ConvertUsing<DateTimeToAvailableDateConverter>();
        CreateMap<IEnumerable<AvailableDate>, IEnumerable <DateTime>>().ConvertUsing<AvailableDateToDateTimeConverter>();
